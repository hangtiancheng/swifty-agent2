 ...
 *
 */
export type EvalRunModel =
  runtime.Types.Result.DefaultSelection<Prisma.$EvalRunPayload>;
...
> = {
   ...
   */
  orderBy?:
    | Prisma.EvalRunOrderByWithRelationInput
    | Prisma.EvalRunOrderByWithRelationInput[];
  /**
...
> = {
  where?: Prisma.EvalRunWhereInput;
  orderBy?:
    | Prisma.EvalRunOrderByWithAggregationInput
    | Prisma.EvalRunOrderByWithAggregationInput[];
...
export type GetEvalRunGroupByPayload<T extends EvalRunGroupByArgs> =
...
> = runtime.Types.Extensions.GetOmit<
  "id" | "triggeredBy" | "datasetSize" | "metrics" | "createdAt",
  ExtArgs["result"]["evalRun"]
>;
...
export type EvalRunGetPayload<
  S extends boolean | null | undefined | EvalRunDefaultArgs,
...
> {
  [K: symbol]: {
    types: Prisma.TypeMap<ExtArgs>["model"]["EvalRun"];
    meta: { name: "EvalRun" };
  };
  /**
  ...
  >(
    args: Prisma.SubsetIntersection<T, EvalRunGroupByArgs, OrderByArg> &
      InputErrors,
  ): {} extends InputErrors
    ? GetEvalRunGroupByPayload<T>
...
> = {
   ...
   */
  data: Prisma.XOR<
    Prisma.EvalRunCreateInput,
    Prisma.EvalRunUncheckedCreateInput
  >;
};
...
> = {
   ...
   */
  data: Prisma.XOR<
    Prisma.EvalRunUpdateInput,
    Prisma.EvalRunUncheckedUpdateInput
  >;
  /**
...
> = {
  ...
  data: Prisma.XOR<
    ...
    Prisma.EvalRunUncheckedUpdateManyInput
  >;
  /**
